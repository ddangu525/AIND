...
class PlanningGraph():
    ...
    def add_literal_level(self, level):
        ...
        state_nodes = set()
        a_level = self.a_levels[level-1]  # S0 A0 S1 A1 ....
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return bool(add1 & rem2) | bool(add2 & rem1)
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        pre_pos1 = set(node_a1.action.precond_pos)
        pre_neg1 = set(node_a1.action.precond_neg)
        add1 = set(node_a1.action.effect_add)
        rem1 = set(node_a1.action.effect_rem)

        pre_pos2 = set(node_a2.action.precond_pos)
        pre_neg2 = set(node_a2.action.precond_neg)
        add2 = set(node_a2.action.effect_add)
        rem2 = set(node_a2.action.effect_rem)

        return bool(pre_pos1 & rem2) | bool(pre_neg1 & add2) | bool(pre_pos2 & rem1) | bool(pre_neg2 & add1)
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # pre_neg2 = set(node_a2.action.precond_neg)
        #
        # return (pre_pos1 & pre_neg2) | (pre_pos2 & pre_neg1)
    ...
    def h_levelsum(self) -> int:
        ...
        for cur_level, state in enumerate(self.s_levels):
            for node in state:
                literal = expr(node.symbol) if node.is_pos else expr('~{}'.format(node.symbol))
                if literal in goals:
                    level_sum += cur_level
